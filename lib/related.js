...
const CLUSTERS = [
  // PDF Toolkit
  ["merge-pdf", "compress-pdf", "split-pdf", "word-to-pdf", "pdf-to-jpg", "pdf-to-png", "pdf-to-text", "jpg-to-pdf", "rotate-pdf", "protect-pdf", "reorder-pages", "delete-pdf-pages", "extract-pdf-pages", "crop-pdf", "add-page-numbers", "add-text-to-pdf", "esign-pdf", "create-pdf", "watermark-pdf"],
  // Image Editing
  ["image-compressor", "image-resizer", "crop-image", "rotate-image", "meme-generator", "favicon-generator", "black-and-white", "sepia-image", "invert-colors", "brightness-contrast", "blur-image", "sharpen-image", "pixelate-image", "add-border-to-image", "add-text-to-image", "round-image", "combine-images", "collage-maker"],
  ...
  ["json-formatter", "json-minify", "csv-to-json", "json-to-csv", "xml-to-json", "json-to-xml", "xml-to-csv", "csv-to-xml", "csv-to-markdown", "csv-to-html", "html-to-text", "markdown-to-html", "base64-encode-decode", "url-encode-decode", "url-parser", "number-base-converter"],
