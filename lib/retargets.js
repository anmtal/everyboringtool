...
export const RETARGETS = {
  ...
  "mute-video": {
    ...
    seoTitle: "Remove Audio from Video — Free, Nothing Uploaded",
    metaDescription: "Free tool to remove the audio track from a video and download the silent clip — MP4, MOV and WebM, right in your browser. Nothing is uploaded; it mutes video too.",
    aboutAppend: "It's the quick way to remove audio from a video — drop in a clip, strip the soundtrack, and download the muted version, all in your browser with nothing uploaded.",
  },
};
